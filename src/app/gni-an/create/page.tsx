...
function CreateForm() {
  ...
  const { project, setProject, ideation, summary, getCompletedExpertsCount } = useProjectStore();
  ...
  function handleSubmit() {
    ...
    router.push('/gni-an/proposal/basis-background');
  }
    ...
    <div className="min-h-screen bg-[#F7F8F2]">
      <header className="border-b border-[#D9E6B7] bg-white/80 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-3xl mx-auto px-6 h-14 flex items-center gap-2">
          <Link href="/gni-an/ideation/summary" className="flex items-center gap-1.5 text-gray-400 hover:text-[#8AA81E] transition-colors text-sm">
            <ArrowLeft size={15} />
          </Link>
