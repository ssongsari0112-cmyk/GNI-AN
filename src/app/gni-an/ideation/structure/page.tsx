...
export default function StructurePage() {
  ...
  const { ideation, ideationAnalysis, expertSessions, project, setStructure, setInsights, insights, structure, projectType, pmcSourceDocs, clarifyMessages } = useProjectStore();
