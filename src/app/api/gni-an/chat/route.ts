...
import { getAnthropicClient, isApiKeyConfigured } from '@/lib/api/anthropic';
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!isApiKeyConfigured()) {
      ...
      const mock = 'API 키가 설정되지 않았습니다. .env.local 파일에 ANTHROPIC_API_KEY를 입력하시면 실제 AI 답변을 받으실 수 있습니다.';
