...
3. Outcomes(성과/산출목적): 구체적인 사업 성과 (반드시 2~3개, 각각 outputs 포함)
   - 문제나무의 직접 원인을 긍정적으로 전환
   - 각 성과에 산출물(Output)을 반드시 2~3개 추가 (절대 1개만 만들지 말 것 —
     서로 다른 측면에서 구체적 결과물을 도출할 것)
...
- Outcomes: 반드시 2~3개 (직접 원인 전환, 각각 산출물 반드시 2~3개 포함 — 절대 1개만 만들지 말 것)
