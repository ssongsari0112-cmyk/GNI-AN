...
- Output: 각 Outcome의 children에 1~3개
- Activity: 각 Output의 children에 1~4개
...
[수정 요청인 경우]
- 기존 PDM 구조와 작성된 내용은 최대한 유지하고, 요청된 부분만 추가/수정/삭제하세요.
...
- updatedPdm에는 전체 PDM 배열(수정된 부분 포함 전체)을 담으세요.
