...
[최우선] "사업 아이디어" 텍스트 안에 "~꼭 추가해줘", "~포함해줘", "~빠지지 않게 해줘"처럼 사용자가
직접 요청한 구체적 내용이 있으면 절대 빠뜨리지 말고 interventionApproach 또는 expectedOutcomes에
명시적으로 반영하세요. 이후 목표나무·PDM 생성 단계에서도 이어지므로 일반론으로 흐리지 말 것.
